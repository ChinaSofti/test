              ...
              reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        initWithFrame:CGRectMake (FITWIDTH (33), 0, (bgdView.frame.size.width - 2 * FITWIDTH (33)) * 0.45,
                                  FITHEIGHT (132))];
        ...
        initWithFrame:CGRectMake (_keyLabel.rightX, 0, (bgdView.frame.size.width - 2 * FITWIDTH (33)) * 0.55,
                                  FITHEIGHT (132))];
