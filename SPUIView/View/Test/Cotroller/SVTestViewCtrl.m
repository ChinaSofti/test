...
#pragma mark - 在这里对 数组 排序
  SVCurrentResultModel *currentResultModel =
      [[SVCurrentResultModel alloc] init];
  ...
  //    SVCurrentResultViewCtrl *currentResultView = [[SVCurrentResultViewCtrl
  //    alloc] init];
  ...
  //    completion:nil];
  //    [navigationController pushViewController:currentResultView
  //    animated:YES];
